...
public class Replace extends SQL {
	/**
	 *
	 */
	private static final long serialVersionUID = 1L;

	public Replace(Table table, boolean isPrepared, Distribution distribution) {
		this.table = table;
	...
	public Replace(Replace replace) {
		this.table = replace.table;
		this.isPrepared = replace.isPrepared;
		this.distribution = replace.distribution;
	}

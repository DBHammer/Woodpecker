...
public class SelectForUpdate extends SQL {
	/**
	 * 
	 */
	...
	public SelectForUpdate(Table table, boolean isPrepared, Distribution distribution,
	...
	public SelectForUpdate(SelectForUpdate selectForUpdate) {
		this.table = selectForUpdate.getTable();
		this.isPrepared = selectForUpdate.isPrepared;
		this.distribution = selectForUpdate.distribution;
		this.selectedColumnList = selectForUpdate.selectedColumnList;
		this.filter =  selectForUpdate.filter;
		this.append = selectForUpdate.append;
	}
